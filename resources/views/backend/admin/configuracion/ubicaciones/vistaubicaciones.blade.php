...
@stop
    ...
    @section('js')
        ...
        <script>
            $(function () {
                const ruta = "{{ url('/admin/ubicaciones/tabla/index') }}";
    ...
    <script>
        ...
        function recargar(){
            var ruta = "{{ url('/admin/ubicaciones/tabla/index') }}";
        ...
        function nuevo(){
            ...
            axios.post(urlAdmin+'/admin/ubicaciones/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function informacion(id){
            ...
            axios.post(urlAdmin+'/admin/ubicaciones/informacion',{
                'id': id
            })
                .then((response) => {
                    closeLoading();
        ...
        function editar(){
            ...
            axios.post(urlAdmin+'/admin/ubicaciones/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function borrar(id) {
            Swal.fire({
                ...
                if (result.value) {
                    openLoading();
                    axios.post(urlAdmin + '/admin/ubicaciones/borrar', { id: id })
                        .then((response) => {
                            closeLoading();
                            switch (response.data.success) {
                                ...
                                case 3:
                                    ...
                                    break;
                                case 2:
                                    toastr.error('La ubicación no existe');
                                    recargar();
                                    break;
                                default:
